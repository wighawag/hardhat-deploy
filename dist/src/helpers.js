        ...
        if (implementation.newlyDeployed) {
            ...
            if (!proxy) {
                ...
                try {
                    ...
                    currentOwner = address_1.getAddress(bignumber_1.BigNumber.from(ownerStorage).toHexString());
                }
                ...
                const executeReceipt = await execute(proxyName, Object.assign(Object.assign({}, options), { from: currentOwner }), 'changeImplementation', implementation.address, data);
                if (!executeReceipt) {
