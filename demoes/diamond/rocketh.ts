...
import {diamond} from '@rocketh/diamond'; // this one provide functions to deploy diamonds declaratively
const functions = {...deployFunctions, ...readExecuteFunctions, diamond};
// ------------------------------------------------------------------------------------------------
